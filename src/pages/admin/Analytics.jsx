...
const Analytics = () => {
  ...
  const metricConfig = {
    bookings: { label: 'Total Bookings', color: '#3b82f6', bgColor: 'rgba(59, 130, 246, 0.1)' },
    users: { label: 'Active Users', color: '#10b981', bgColor: 'rgba(16, 185, 129, 0.1)' },
    revenue: { label: 'Revenue ($)', color: '#f59e0b', bgColor: 'rgba(245, 158, 11, 0.1)' },
    sessions: { label: 'Sessions', color: '#ef4444', bgColor: 'rgba(239, 68, 68, 0.1)' },
    conversion: { label: 'Conversion Rate (%)', color: '#8b5cf6', bgColor: 'rgba(139, 92, 246, 0.1)' }
  };
  ...
  const keyMetrics = [
    ...
    {
      title: 'Revenue',
      value: `$${(currentData.revenue[currentData.revenue.length - 1] / 1000).toFixed(1)}k`,
      change: '+15.2%',
      changeType: 'positive',
  ...
  const recentActivity = [
    { action: 'New booking created', value: '$1,250', time: '2 minutes ago' },
    { action: 'User registration', value: '+1', time: '5 minutes ago' },
    { action: 'Payment processed', value: '$850', time: '12 minutes ago' },
    { action: 'Review submitted', value: '5 stars', time: '18 minutes ago' },
    { action: 'Guide verified', value: '+1', time: '25 minutes ago' }
  ];
          ...
          <div className="lg:col-span-4 bg-white dark:bg-secondary-800 rounded-xl border border-gray-200 dark:border-secondary-700 p-6">
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="flex space-x-2">
                {['user1', 'user2', 'user3'].map((user) => (
                  ...
                  >
                    {user === 'user1' ? 'Overall' : user === 'user2' ? 'Travelers' : 'Providers'}
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="flex space-x-4 mb-6">
              <div className="flex items-center space-x-2">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Left Axis:</label>
                <select
                  value={leftMetric}
              ...
              <div className="flex items-center space-x-2">
                <label className="text-sm font-medium text-gray-700 dark:text-gray-300">Right Axis:</label>
                <select
                  value={rightMetric}
          ...
          <div className="lg:col-span-2 bg-white dark:bg-secondary-800 rounded-xl border border-gray-200 dark:border-secondary-700 p-6">
            ...
            <div className="space-y-4">
              {keyMetrics.map((metric, index) => {
                ...
                return (
                  <div key={index} className={`p-4 rounded-lg border ${getMetricCardColor(metric.color)} transition-all hover:scale-105`}>

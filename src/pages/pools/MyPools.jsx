        ...
        <>
          ...
          {ongoingPool ? (
                ...
                <div className="flex-1 flex flex-col p-8">
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex items-center text-gray-600">
                      ...
                      <span className="text-sm">{ongoingPool.memberCountText || `${ongoingPool.participants}/${ongoingPool.maxParticipants} participants`}</span>
                    </div>
                  </div>
                  {/* Itinerary Timeline */}
            ...
            <div className="mb-12 max-w-4xl mx-auto">
              ...
              <div className="text-center py-8 text-gray-500 border-2 border-dashed border-gray-300 rounded-2xl">
                <div className="text-lg font-medium mb-2">No ongoing pools</div>
                <div className="text-sm">You don't have any active pools right now.</div>
              </div>
            </div>
          )}
          ...
          <div className="mb-12">
            ...
            {upcomingPools.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                <div className="text-lg font-medium mb-2">No upcoming pools</div>
                <div className="text-sm">You haven't joined any upcoming pools yet.</div>
              </div>
            ) : (
          ...
          <div>
            ...
            {poolHistory.length === 0 ? (
              <div className="text-center py-8 text-gray-500">
                <div className="text-lg font-medium mb-2">No pool history</div>
                <div className="text-sm">You haven't completed any pools yet.</div>
              </div>
            ) : (
              <div className="overflow-x-auto pb-2">
                <div className="flex gap-6 min-w-[600px]">

...
const Button = ({
  ...
  const sizeClasses = {
    xs: 'px-2 py-1 text-xs rounded-full min-h-[32px]',
    sm: 'px-3 py-1.5 text-sm rounded-full min-h-[36px]',
    md: 'px-4 py-2 text-sm sm:text-base rounded-full min-h-[44px]',
    lg: 'px-6 py-3 text-base sm:text-lg rounded-full min-h-[48px]',
    xl: 'px-8 py-4 text-lg sm:text-xl rounded-full min-h-[52px]',
  };

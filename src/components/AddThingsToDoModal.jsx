    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-2">Choose an activity to add to your itinerary, then select which days you'll do it.</p>
        ...
        <div className="flex">
          {/* Left Side - Activity Selection */}
          <div className="flex-1 p-6 overflow-y-auto max-h-[calc(90vh-160px)]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {getFilteredSuggestions().map((activity) => (
                <div key={activity.id} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-all cursor-pointer group">
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-lg font-bold text-primary-600">{activity.price}</p>
                      </div>
                    </div>
                    ...
                    <button
                      onClick={() => addItemToItinerary(activity, selectedStayDates)}
            ...
            {getFilteredSuggestions().length === 0 && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>Try searching for a different activity.</p>
              </div>
            )}
          </div>
          {/* Right Side - Calendar */}
          <div className="w-80 bg-gradient-to-b from-primary-50 to-white border-l border-gray-200 p-6">
            <div className="sticky top-0">
              <div className="flex items-center mb-4">
                ...
                <h4 className="font-semibold text-gray-900">Select activity dates</h4>
              </div>
              <p className="text-sm text-gray-600 mb-6">
                Choose which days you'll do this activity. You can select multiple consecutive or separate days.
              </p>

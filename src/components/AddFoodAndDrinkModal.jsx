    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl max-w-6xl w-full max-h-[90vh] overflow-hidden">
        <div className="p-6 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-2">Choose a restaurant or dining experience, then select which days you'll dine there.</p>
                ...
                {suggestions.map((dining) => (
                  <div key={dining.id} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-all cursor-pointer group">
                    <div className="relative">
                      <img 
                        src={dining.image || dining.photos?.[0]?.url || 'https://placehold.co/400x250'} 
          ...
          <div className="w-80 bg-gradient-to-b from-primary-50 to-white border-l border-gray-200 p-6">
            <div className="sticky top-0">
              <div className="flex items-center mb-4">
                ...
                <h4 className="font-semibold text-gray-900">Select dining dates</h4>
              </div>
              <p className="text-sm text-gray-600 mb-6">
                Choose which days you'll dine at this place. You can select multiple consecutive or separate days.
              </p>

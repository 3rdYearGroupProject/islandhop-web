        ...
        <div className="flex">
          ...
          <div className="flex-1 p-6 overflow-y-auto max-h-[calc(90vh-160px)]">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {getFilteredSuggestions().map((place) => (
                <div key={place.id} className="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-all cursor-pointer group">
                  ...
                  <div className="p-4">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <h4 className="font-bold text-lg text-gray-900">{place.name}</h4>
                        <p className="text-sm text-gray-500">{place.location}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-sm font-semibold text-gray-900">from</p>
                        <p className="text-lg font-bold text-primary-600">{place.price}</p>
                      </div>
                    </div>
            ...
            {getFilteredSuggestions().length === 0 && (
              <div className="text-center py-12 text-gray-500">
                ...
                <p>Try searching for a different accommodation.</p>
              </div>
            )}
          </div>
          {/* Right Side - Calendar */}

        ...
        <div className="flex flex-col h-full pt-16">
          ...
          <div className="lg:hidden px-4 py-4 border-b border-gray-200 dark:border-secondary-700">
            <div className="grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center p-3 bg-green-100 dark:bg-green-900/20 text-green-700 dark:text-green-400 rounded-lg font-medium text-sm">
          ...
          <div className="lg:hidden px-4 py-4 border-t border-gray-200 dark:border-secondary-700">
            <div className="space-y-2">
              <button className="w-full flex items-center justify-center px-4 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm font-medium transition-colors duration-200">
